const productsData = [
  ...
  { id: 5, price: 166, name: "Pele's World Cup Ball", description: "Etiam ultricies in dui ac porttitor. Nulla venenatis interdum tortor, volutpat consequat eros euismod in. Donec non tincidunt felis, sit amet luctus erat. Sed eget diam maximus, iaculis urna in, ullamcorper eros. Nullam semper dui et ultricies accumsan. Donec eget lacus elementum, varius orci at, interdum ante. Pellentesque egestas aliquam.", category: "Ziless", image_path:"peleBall.jpg"},
  { id: 6, price: 145, name: "Serena Williams Broken Rackets", description: "Nunc egestas tempor mi sit amet mattis. Aliquam erat volutpat. Ut tempor accumsan ex, in consequat nunc. Etiam felis quam, accumsan sit amet nulla non, interdum tristique arcu. Integer ut nisl ipsum. Integer ac eros elit. Mauris pharetra ante nunc, sit amet elementum turpis efficitur in. Sed vitae purus in.", category: "Soqor", image_path:"sernasBrokenRackets.jpg"},
  { id: 7, price: 126, name: "Zeus's Lighting Bolt", description: "Morbi tristique elit risus, nec condimentum lorem egestas sit amet. Nulla eget suscipit tortor, nec rutrum nibh. In hac habitasse platea dictumst. Mauris mauris eros, porttitor at aliquam sed, malesuada non neque. Quisque ut ipsum nec mi ultrices porttitor quis eget eros. Curabitur sollicitudin justo quis ligula rhoncus scelerisque. In.", category: "Etior", image_path:"zuesbolt.jpg"},
  { id: 8, price: 114, name: "Magic Johnson's 1987 Championship Jersey", description: "Sed augue lorem, facilisis eu enim vel, volutpat facilisis nunc. In faucibus erat quis rutrum. Sed nec mi egestas, aliquet tellus nec, dictum tortor. Phasellus interdum in enim id sodales. Donec in varius sem. Quisque euismod tellus arcu, vel vehicula turpis pellentesque quis. Vivamus nec ultrices mi. Pellentesque feugiat.", category: "Meylu", image_path:"magicJohnson.jpeg"},
  { id: 9, price: 102, name: "Larry Bird's 1986 Championship Jersey", description: "Maecenas lacinia urna arcu, sit amet vestibulum sapien vulputate quis. Pellentesque vestibulum, ipsum ut fringilla consequat, lacus lorem vestibulum felis, quis porttitor lorem nisi a arcu. In pretium egestas enim, at ornare tortor convallis a. Praesent ligula erat, commodo sed felis in, dictum blandit mauris. Vivamus nunc enim, sodales vel.", category: "Rheviar", image_path:"larryBird.png"},
  { id: 10, price: 59, name: "Wayne Gretzky's 1987 Stanley Cup Jersey", description: "In facilisis, purus eu aliquet porttitor, lorem justo mattis sapien, et interdum tortor orci eu felis. Nullam lacinia dui quis eleifend suscipit. Vivamus condimentum nunc non congue efficitur. In quis eros dignissim, sagittis est et, venenatis metus. Etiam dignissim quis nibh at consequat. Nunc non mi aliquet, pulvinar nulla a.", category: "Zallaes", image_path:"wayneGretzky.jpeg"},
  { id: 11, price: 46, name: "Messi's World Cup Jersey", description: "Duis tempus urna non vulputate consectetur. Nullam cursus, justo vel imperdiet interdum, urna massa imperdiet nulla, a laoreet neque risus et lectus. Integer varius fermentum ornare. Maecenas ornare libero non aliquam consectetur. Donec in justo non libero viverra laoreet ac id nunc. Ut ac mi urna. Nunc sem dui, posuere.", category: "Chalyn", image_path:"messi.jpeg"},
  { id: 12, price: 30, name: "Steph Curry's 2022 Championship Jersey", description: "Quisque pulvinar tellus vel mattis venenatis. Interdum et malesuada fames ac ante ipsum primis in faucibus. Duis aliquet ex at lacus sodales, eget malesuada ex porttitor. Morbi volutpat, tellus tincidunt sagittis ultricies, sem tortor pulvinar ante, vitae gravida enim mauris ac nulla. Curabitur euismod imperdiet lectus ac volutpat. Etiam sed.", category: "Esufyne", image_path:"stephcurry.jpeg"},
  { id: 13, price: 21, name: "Payton Manning's Super Bowl 50 Jersey", description: "Cras cursus justo nec tortor sodales, tincidunt posuere massa pulvinar. Quisque neque ex, venenatis eget ante nec, volutpat ultrices elit. Pellentesque varius magna turpis, ac tempus dui convallis quis. Quisque porttitor semper purus quis scelerisque. Donec consectetur ullamcorper risus, nec consectetur ligula laoreet sit amet. Morbi non eros quam. In.", category: "Grikius", image_path:"paytonmanning.jpeg"},
  { id: 14, price: 10, name: "Megan Rapinoe's World Cup Jersey", description: "Phasellus dignissim mauris ac dapibus aliquet. Pellentesque congue nibh rutrum, fringilla arcu eu, dignissim est. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aliquam non ligula eleifend, interdum erat a, ornare nulla. Nunc in aliquam ex, non maximus ipsum. Praesent varius metus vitae nibh rutrum.", category: "Avile", image_path:"meganrapinoe.jpeg"}
];
